...
- `assets/physcodebench.pdf`: 30-page single-column revised preprint with the technical appendix and updated twelve-author list, using the first arXiv version's LNCS layout.
...
Authorship was updated on September 11, 2026 from the author-supplied list and affiliations. Tianyidan Xie and Zili Yi are corresponding authors. Keep the author block, BibTeX, and downloadable paper consistent.
